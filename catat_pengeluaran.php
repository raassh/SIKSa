		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="tambah.php" method="post">
				...
				<div class="wrap-input100 bg1 rs1-wrap-input100">
					...
					<input class="input100" type="text" name="jml_pengeluaran" placeholder="Masukkan jumlah pengeluaran (RP)">
				</div>


				<div class="wrap-input100 validate-input bg1 " data-validate = "Jenis pengeluaran kosong" >
					<span class="label-input100">JENIS PENGELUARAN *</span>
					<input class="input100" type="text" name="jns_pengeluaran" placeholder="Masukkan jenis pengeluaran ">
				</div>
